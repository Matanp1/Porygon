...
#include <Robot.h>
#include "../RobotMap.h"
#include "../Commands/Chassic/DriveByJoystick.h"
...
void Chassis::InitDefaultCommand() {
	...
	SetDefaultCommand(new DriveByJoystick(Robot::driver_stick));
}
...
void Chassis::Drive(Joystick* stick)
{
	...
	rotation = (rotation > 0) ? rotation*rotation : -rotation*rotation;
